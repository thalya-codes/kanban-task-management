...
export const ButtonVariants = cva(
  'rounded-2xl py-2 px-5 transition-all w-full font-medium text-sm',
  {
    variants: {
      variant: {
        ...
        'link-medium-gray':
          'text-neutral-medium-gray hover:underline font-normal',
        'link-red': 'text-primary-red hover:underline font-normal',
        drawer:
